...
const { uploadProducts, uploadProfile, uploadKits } = require('../middleware/upload');
...
router.get('/orders/by-number/:orderNumber',                    protect, ctrl.getOrderByNumber);
router.get('/orders/:id/invoice',                               protect, ctrl.getOrderInvoice);
router.get('/orders/:id',                                       protect, ctrl.getOrderById);
...
router.post('/kits',              protect, authorize('admin'), uploadKits.single('image'), kitCtrl.createKit);
router.patch('/kits/:id',         protect, authorize('admin'), uploadKits.single('image'), kitCtrl.updateKit);
